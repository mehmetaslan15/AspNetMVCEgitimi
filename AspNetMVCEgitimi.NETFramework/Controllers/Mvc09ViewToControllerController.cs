...
namespace AspNetMVCEgitimi.NETFramework.Controllers
{
    public class Mvc09ViewToControllerController : Controller
    {
        ...
        public ActionResult Index(string txtAra)  //Mvc de index metodu içerisie bu şekilde parametre ekleyerek
            //ön yüzden gönderilen veriyi yakalayabiliyoruz. Dikkat ! Eşleşme sağlanabilmesi için ön yüzdeki 
            //elemanın name bilgisi ile buradaki değişken bilgisinin aynı isimde olması lazım yoksa eşleşmez!!
        {
        ...
        public ActionResult Index(string text1, string ddlListe, bool cbOnay)
        {
            ...
            //2. Yöntem Request.Form ile sayfadaki elementlerden veri alma
            var txt = Request.Form["text1"];
            var ddl = Request.Form["ddlListe"];
            //var chb 0 Request.Form["cbOnay"]; true, false dönüyor
