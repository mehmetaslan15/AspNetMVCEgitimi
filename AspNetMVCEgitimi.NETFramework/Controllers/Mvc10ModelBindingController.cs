...
namespace AspNetMVCEgitimi.NETFramework.Controllers
{
    public class Mvc10ModelBindingController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Kullanici(Kullanici kullanici)   //post metodunda ön yüzden gönderilen modeli parametre ile elde
                                                            // edebiliriz. 
        {
            ...
            return View(kullanici);  //post işleminden sonra kullanıcı nesnesini sayfaya tekrar geri gönderebiliriz. 
        }
        ...
        public ActionResult Adres(Adres adres)
        {
            ...
            return View(adres);  //buarada post işleminden sonra adres nesnesini view a göndermezsek null reference hatası 
                                   // alırız ! 
        }
