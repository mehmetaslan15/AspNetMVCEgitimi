...
namespace AspNetMVCEgitimi.NETFramework.Areas.Admin.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {
            return View(context.Categories.ToList()); //veritabanındaki kategorilerin listesini veiw a gönder. 
        }
        ...
        public ActionResult Edit(int? id) // ? işareti id nin null olabileceğini belirtir. 
        {
            ...
            var kategori = context.Categories.Find(id);  //Kategorilerden adres çubuğundan idsi gönderileni bul. 
        ...
        public ActionResult Delete(int? id)
        {
            ...
            Category kategori = context.Categories.Find(id);  //Kategorilerden adres çubuğundan idsi gönderileni bul. 
            return View(kategori);
        }
